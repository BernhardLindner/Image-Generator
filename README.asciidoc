...
| *Method of parallelization* |*# images after about 1 minute of execution*
| pthread |-> 55 Images
| pthread -o3 -mavx -ffast-math |-> 72 Images
| OpenMP |-> 55 Images
| OpenMP -o3 -mavx -ffast-math |-> 72 Images
| OpenCL GPU GeForce GT 650M |-> 82 Images
| OpenCL CPU |-> 111 Images
| pthread-SIMD-SSE |-> 97 Images
| pthread-SIMD-AVX |-> 144 Images
|===
...
| *Method of parallelization* |*# images after about 1 minute of execution*
| pthread |-> 55 Images
| pthread -o3 -mavx -ffast-math |-> 71 Images
| OpenMP -o3 -mavx -ffast-math |-> 70 Images
| OpenCL CPU |-> 133 Images
| pthread-SIMD-SSE |-> 96 Images
| pthread-SIMD-AVX |-> 146 Images
|===
