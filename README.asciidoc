...
In the file link:1_Image-Generator_pthread/shared/include/numberOfPixels.c[/shared/include/numberOfPixels.c]
you can manually change the with of the image.
