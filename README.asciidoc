...
*1.2*
See link:CHANGELOG[CHANGELOG.asciidoc] for details.
...
link:thread_handler.h[/PixelGenerator/include/thread_handler.h]
...
link:setup_OpenCL.h[/include/setup_OpenCL.h]

In the file link:numberOfPixel.h[/shared/include/numberOfPixel.h]
...
In the file link:numberOfPixel.c[/shared/src/numberOfPixel.c]
